...
-- Effects Drinking Directly from Wild Waters
Config.hurtHealth = false -- true Will Reduce Health by wildHealth Value / false will Increase by Value
Config.wildHealth  = 5  -- Default: 5 / Value is 0 - 100

Config.hurtStamina = false -- true Will Reduce Stamina by wildStamina Value / false will Increase by Value
